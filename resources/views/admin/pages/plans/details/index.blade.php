...
@section('content')
    <div class="card">
                ...
                @foreach ($details as $detail)
                    <tr>
                        ...
                        <td style="width= 10rem">
                            <a href="{{ route('details.plan.edit', [$plan->url, $detail->id]) }}" class="btn btn-sm btn-info">Edit</a>
                            <a href="{{ route('details.plan.show', [$plan->url, $detail->id]) }}" class="btn btn-sm btn-warning">VER</a>
                        </td>
                    </tr>
                    @endforeach
                    </tbody>
        ...
        <div class="card-footer">
            @if(isset($filters))
            {!! $details->appends($filters)->links('vendor.pagination.bootstrap-4') !!}
            @else
