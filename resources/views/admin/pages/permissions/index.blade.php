...
<ol class="breadcrumb">
    ...
    <h1><a href="{{ route('permissions.create') }}" class="btn btn-dark">ADD</a> Permissões</h1>
@stop
                ...
                @foreach ($permissions as $permission)
                    <tr>
                        ...
                        <td style="width= 10rem">
                            ...
                            <a href="{{ route('permissions.show', $permission->id) }}" class="btn btn-sm btn-warning">VER</a>
                            <a href="{{ route('permissions.profiles', $permission->id) }}" class="btn btn-sm btn-info"><i class="fas fa-address-book"></i></a>
                        </td>
                    </tr>
                    @endforeach
                    </tbody>
